...
from lib.models.gaussian_model import GaussianModel, initial_dist2
...
class GaussianModelActor(GaussianModel):
    ...
    def create_from_pcd(self, spatial_lr_scale):
        ...
        dist2 = torch.clamp_min(initial_dist2(torch.from_numpy(np.asarray(pointcloud_xyz)).float().cuda()), 0.0000001)
